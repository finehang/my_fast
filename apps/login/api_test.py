...
# 获取请求标头
@router.get("/header/")
async def header(host: Optional[str] = Header(None), accept_language: Optional[str] = Header(None)):
...
# 获取表单参数
@router.post("/form/")
async def form(name: str = Form(...), sex: str = Form(...), age: int = Form(...), home: str = Form(...)):
